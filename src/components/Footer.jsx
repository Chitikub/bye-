      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between text-sm">
          ...
          <div className="flex items-center justify-center gap-2">
            <a href="https://youtube.com/@moodlocationfinder?si=KZgAr6TuFUDbj73Y" className="w-9 h-9 rounded-full bg-white border border-[#EFE9D9] flex items-center justify-center text-[#4A453A] hover:bg-[#3b5998] hover:text-white transition-all shadow-sm" target="blank">
