      ...
      <main className="container mx-auto px-4 sm:px-6 pt-32 pb-24 relative z-10">
        ...
        <section className="max-w-4xl mx-auto text-center mb-24">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 px-4 py-2 bg-orange-50 text-[#FF8E6E] rounded-full font-bold text-sm mb-4"
            >
              <Sparkles size={16} /> คู่มือการใช้งาน
            </motion.div>
            <motion.h1
              variants={fadeUp}
              className="text-4xl sm:text-5xl md:text-7xl font-black leading-tight tracking-tight text-[#2D2A26]"
            >
            ...
            <motion.p
              variants={fadeUp}
              className="text-lg sm:text-xl text-[#7E7869] font-medium leading-relaxed max-w-2xl mx-auto px-4"
            >
              <span className="text-[#FF8E6E]">MoodLocation Finder</span>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="flex-1 space-y-6 order-2 lg:order-1">
              ...
              <p className="text-[#7E7869] text-lg font-medium leading-relaxed">
                ...
                หรือสมัครสมาชิกก่อนใช้งาน
                เพื่อให้ระบบสามารถจดจำประวัติการเดินทาง และให้คุณสามารถกด
                "ถูกใจ" สถานที่ที่ชอบเก็บไว้ดูทีหลังได้
              </p>
              <ul className="space-y-3 mt-6 text-[#7E7869] font-medium">
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 rounded-full bg-[#FF8E6E]" />{" "}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 w-full max-w-md relative">
              ...
              <div className="bg-white p-8 rounded-[3rem] shadow-xl border border-[#EFE9D9] relative z-10 flex flex-col gap-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="h-24 bg-orange-50 rounded-2xl border-2 border-[#FF8E6E]/30 flex items-center justify-center text-4xl">
                    😄
                  </div>
                  <div className="h-24 bg-gray-50 rounded-2xl flex items-center justify-center text-4xl opacity-50">
                    😢
                  </div>
                  <div className="h-24 bg-gray-50 rounded-2xl flex items-center justify-center text-4xl opacity-50">
                    😡
            ...
            <div className="flex-1 space-y-6">
              ...
              <p className="text-[#7E7869] text-lg font-medium leading-relaxed">
                ...
                "เหนื่อยจัง", "อยากพักผ่อน" ระบบ AI
                อัจฉริยะของเราจะวิเคราะห์ความรู้สึกและหาสถานที่บำบัดใจให้คุณทันที
                <br />
                <br />
                <strong>วิธีที่ 2: กดเลือกจากไอคอนอารมณ์</strong>{" "}
                หากไม่รู้จะพิมพ์อะไร
                ก็กดเลือกอิโมจิที่ตรงกับความรู้สึกของคุณมากที่สุดได้เลย
              </p>
            </div>
          </div>
        </motion.section>
        ...
        >
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="flex-1 space-y-6 order-2 lg:order-1">
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-[#2D2A26]">
                3. เลือกสถานที่และตรวจสอบระยะทาง
              </h2>
              <p className="text-[#7E7869] text-lg font-medium leading-relaxed">
                ระบบจะดึงสถานที่จาก{" "}
                <strong className="text-blue-500">Google Maps</strong>{" "}
                ที่สอดคล้องกับอารมณ์ของคุณ โดยจะ{" "}
                <strong className="text-[#FF8E6E]">
                  คำนวณระยะทางขับรถจริง และเวลาเดินทาง (นาที)
                </strong>{" "}
                ให้คุณเสร็จสรรพ พร้อมเรียงลำดับจากสถานที่ที่ใกล้ที่สุดขึ้นมาก่อน
              </p>
              <div className="bg-orange-50 border border-orange-100 rounded-2xl p-6 mt-6">
                <p className="text-[#FF8E6E] font-bold flex items-start gap-3">
                  ...
                  อย่าลืมกด "อนุญาต (Allow)" ให้เบราว์เซอร์เข้าถึงตำแหน่ง (GPS)
                  ของคุณ เพื่อให้ระบบคำนวณระยะทางได้อย่างแม่นยำนะครับ
                </p>
              </div>
            </div>
        ...
        >
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 w-full max-w-md relative">
              ...
              <div className="bg-white p-8 rounded-[3rem] shadow-xl border border-[#EFE9D9] relative z-10 flex flex-col gap-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-green-100 rounded-full shrink-0 flex items-center justify-center">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-white border-4 border-[#FF8E6E] rounded-full shrink-0 flex items-center justify-center text-xs font-bold text-[#FF8E6E]">
                    1
                  </div>
            ...
            <div className="flex-1 space-y-6">
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-[#2D2A26]">
                4. จัดการรายการโปรด & วางแผนทริป
              </h2>
              <p className="text-[#7E7869] text-lg font-medium leading-relaxed">
                เมื่อเจอร้านที่ใช่ กดไอคอน ❤️ เพื่อเก็บเข้า{" "}
                <strong>"รายการโปรด"</strong> (บันทึกได้สูงสุด 10 แห่ง)
                <br />
                <br />
                จากนั้นไปที่เมนู <strong>"วางแผนการเดินทาง"</strong>{" "}
                ระบบจะนำสถานที่โปรดทั้งหมดมาจัดเรียงบน Timeline
                ตามระยะทางให้คุณเห็นภาพรวมของทริป และกดนำทางผ่าน Google Maps
                ได้ทันที!
              </p>
            </div>
          </div>
